...
gulp.task('js', function () {
 return gulp.src(['*.{js,html}', '!bower_components/**/*', '!gulpfile.js', '!index.html'])
...
gulp.task('start', shell.task('/usr/local/node/bin/polymer serve --hostname 0.0.0.0'));
gulp.task('watch', function() {
  return gulp.watch(['*.html', '!bower_components/**/*.html'], ['js']);
});
